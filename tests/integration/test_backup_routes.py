...
class TestBackupIndexRoute:
    ...
    def test_index_loads(self, app, client):
...
class TestBackupCreateRoute:
    ...
    def test_create_backup_no_data(self, app, client):
    ...
    def test_create_backup_with_data(self, app, client, db):
    ...
    def test_create_backup_without_uploads(self, app, client):
...
class TestBackupRestoreRoute:
    ...
    def test_restore_no_file(self, app, client):
        """Test restore without providing a file."""
        with app.app_context():
            response = client.post("/backup/restore", data={}, follow_redirects=True)

            assert response.status_code == 200
            assert b"No backup file provided" in response.data

    def test_restore_empty_filename(self, app, client):
    ...
    def test_restore_invalid_format(self, app, client):
    ...
    def test_restore_valid_backup(self, app, client, db):
    ...
    def test_restore_with_clear_existing(self, app, client, db):
    ...
    def test_restore_invalid_backup_file(self, app, client):
